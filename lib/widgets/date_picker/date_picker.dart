...
class _DatePickerComponent extends StatelessWidget {
  ...
  final double _pickerWidth;

  _DatePickerComponent(
      {Key? key,
      required this.route,
      required pickerHeight,
      required pickerWidth})
      : this._pickerHeight = pickerHeight,
        this._pickerWidth = pickerWidth,
        super(key: key);
            ...
            child: new ClipRect(
              child: new CustomSingleChildLayout(
                delegate: new _BottomPickerLayout(route.animation!.value,
                    isDialog: true,
                    contentHeight: _pickerHeight, contentWidth: _pickerWidth),
                child: pickerWidget,
              ),
            ),
          ),
...
class _BottomPickerLayout extends SingleChildLayoutDelegate {
  _BottomPickerLayout(this.progress,
      {required this.contentHeight, required this.contentWidth,required this.isDialog});
